package mp.com.boundarycallbacks

import android.arch.lifecycle.LiveData
import android.arch.lifecycle.MutableLiveData
import android.arch.paging.PagedList
import android.util.Log
import mp.com.network.getNowShowingMovies
...
class NowShowingBoundaryCallbacks(
        ...
        private val cache: mp.com.database.localcache.NowShowingLocalCache) : PagedList.BoundaryCallback<mp.com.database.entities.NowShowingEntry>() {
    ...
    override fun onItemAtEndLoaded(itemAtEnd: mp.com.database.entities.NowShowingEntry) {
    ...
    private fun requestAndSaveNowShowingData(region: String) {
        ...
        getNowShowingMovies(service,"en-US",
                ...
                region,
                { movierequest ->
                    val nowShowingEntryList: MutableList<mp.com.database.entities.NowShowingEntry> = mutableListOf()
                    for (i in 0 until movierequest.results!!.size){
                        val nowShowingEntry = mp.com.database.entities.NowShowingEntry()
