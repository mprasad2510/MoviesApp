...
class TopRatedBoundaryCallbacks(
        ...
        private val cache: mp.com.database.localcache.TopRatedLocalCache) : PagedList.BoundaryCallback<mp.com.database.entities.TopRatedEntry>() {
    ...
    override fun onItemAtEndLoaded(itemAtEnd: mp.com.database.entities.TopRatedEntry) {
    ...
    private fun requestAndSaveTopRatedData(region: String) {
        ...
        getTopRatedMovies(service,"en-US",
                ...
                region,
                { movierequest ->
                    val topRatedEntryList: MutableList<mp.com.database.entities.TopRatedEntry> = mutableListOf()
                    for (i in 0 until movierequest.results!!.size){
                        val topRatedEntry = mp.com.database.entities.TopRatedEntry()
