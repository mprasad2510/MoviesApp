...
import mp.com.network.getSearchMovies
...
class SearchBoundaryCallbacks(
        ...
        private val cache: mp.com.database.localcache.SearchLocalCache) : PagedList.BoundaryCallback<mp.com.database.entities.SearchEntry>() {
    ...
    override fun onItemAtEndLoaded(itemAtEnd: mp.com.database.entities.SearchEntry) {
    ...
    private fun requestAndSaveData(query: String) {
        ...
        getSearchMovies(service,query, lastRequestedPage
                ,{ movierequest ->
            val searchEntryList: MutableList<mp.com.database.entities.SearchEntry> = mutableListOf()
            for (i in 0 until movierequest.results!!.size){
                val searchEntry = mp.com.database.entities.SearchEntry()
