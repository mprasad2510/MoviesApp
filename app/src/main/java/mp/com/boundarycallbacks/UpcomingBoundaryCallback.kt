...
import mp.com.network.getUpcomingMovies
...
class UpcomingBoundaryCallback(
        ...
        private val cache: mp.com.database.localcache.UpcomingLocalCache) : PagedList.BoundaryCallback<mp.com.database.entities.UpcomingEntry>() {
    ...
    override fun onItemAtEndLoaded(itemAtEnd: mp.com.database.entities.UpcomingEntry) {
    ...
    private fun requestAndSaveUpcomingData(region: String) {
        ...
        getUpcomingMovies(service,"en-US",
                ...
                region,
                { movierequest ->
                    val upcomingEntryList: MutableList<mp.com.database.entities.UpcomingEntry> = mutableListOf()
                    for (i in 0 until movierequest.results!!.size){
                        val upcomingEntry = mp.com.database.entities.UpcomingEntry()
