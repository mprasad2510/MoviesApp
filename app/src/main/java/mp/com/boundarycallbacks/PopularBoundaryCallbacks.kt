...
import mp.com.network.getPopularMovies
...
class PopularBoundaryCallbacks(
        ...
        private val cache: mp.com.database.localcache.PopularLocalCache) : PagedList.BoundaryCallback<mp.com.database.entities.PopularEntry>() {
    ...
    override fun onItemAtEndLoaded(itemAtEnd: mp.com.database.entities.PopularEntry) {
    ...
    private fun requestAndSavePopularData(region: String) {
        ...
        getPopularMovies(service,"en-US",
                ...
                region,
                { movierequest ->
                    val popularEntryList: MutableList<mp.com.database.entities.PopularEntry> = mutableListOf()
                    for (i in 0 until movierequest.results!!.size){
                        val popularEntry = mp.com.database.entities.PopularEntry()
