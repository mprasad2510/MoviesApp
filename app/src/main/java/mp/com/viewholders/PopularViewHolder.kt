...
class PopularViewHolder(itemView: View?,
    ...
    private var movie: mp.com.database.entities.PopularEntry? = null
    ...
    fun bindPopularData(movie: mp.com.database.entities.PopularEntry?, mSharedPreferences: SharedPreferences) {
        if (movie == null) {
            return
        } else {
    ...
    private fun convertEntryToMovieList(movie: mp.com.database.entities.PopularEntry): mp.com.models.Movie {
