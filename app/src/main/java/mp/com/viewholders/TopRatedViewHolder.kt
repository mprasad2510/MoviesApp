...
class TopRatedViewHolder(itemView: View?,
    ...
    private var movie: mp.com.database.entities.TopRatedEntry? = null
    ...
    fun bindPopularData(movie: mp.com.database.entities.TopRatedEntry?, mSharedPreferences: SharedPreferences) {
        if (movie == null) {
            return
        } else {
    ...
    private fun convertEntryToMovieList(movie: mp.com.database.entities.TopRatedEntry): mp.com.models.Movie {
