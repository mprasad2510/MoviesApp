...
class NowShowingViewHolder(itemView: View?,
    ...
    private var movie: mp.com.database.entities.NowShowingEntry? = null
    ...
    fun bindNowShowingData(movie: mp.com.database.entities.NowShowingEntry?, mSharedPreferences: SharedPreferences) {
        if (movie == null) {
            return
        } else {
    ...
    private fun convertEntryToMovieList(movie: mp.com.database.entities.NowShowingEntry): mp.com.models.Movie {
