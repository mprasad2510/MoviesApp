...
class UpcomingViewHolder(itemView: View?,
    ...
    private var movie: mp.com.database.entities.UpcomingEntry? = null
    ...
    fun bindNowShowingData(movie: mp.com.database.entities.UpcomingEntry?, mSharedPreferences: SharedPreferences) {
        if (movie == null) {
            return
        } else {
    ...
    private fun convertEntryToMovieList(movie: mp.com.database.entities.UpcomingEntry): mp.com.models.Movie {
