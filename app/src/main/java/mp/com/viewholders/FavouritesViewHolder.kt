...
class FavouritesViewHolder(itemView: View?,
    ...
    private var movie: mp.com.database.entities.FavouritesEntry? = null
    ...
    fun bindFavoriteData(movie: mp.com.database.entities.FavouritesEntry?, mSharedPreferences: SharedPreferences) {
        if (movie == null) {
            return
        } else {
    ...
    private fun convertEntryToMovieList(movie: mp.com.database.entities.FavouritesEntry): mp.com.models.Movie {
