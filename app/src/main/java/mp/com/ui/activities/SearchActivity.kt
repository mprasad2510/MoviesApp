...
import mp.com.utils.Constants.Companion.SEARCHES
import mp.com.viewmodels.SearchViewModel

class SearchActivity : AppCompatActivity(), mp.com.interfaces.OnMovieClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private lateinit var mSearchAdapter: mp.com.adapters.SearchAdapter
    ...
    private fun initViews(){
        ...
        mDatabase = mp.com.database.AppDatabase.getInstance(this)
    }

    private fun initSearchRecyclerView(){
        configureRecyclerAdapter(resources.configuration.orientation)
        viewModel = ViewModelProviders.of(this, mp.com.Injection.provideSearchViewModelFactory(this))
                .get(SearchViewModel::class.java)

        mSearchAdapter = mp.com.adapters.SearchAdapter(this, mSharedPreferences)
        mSearchRecyclerView.adapter = mSearchAdapter
        Toast.makeText(this,"Started",Toast.LENGTH_SHORT).show()
        viewModel.searches.observe(this, Observer<PagedList<mp.com.database.entities.SearchEntry>> {
    ...
    private fun convertEntryToMovieList(list: List<mp.com.database.entities.SearchEntry>): MutableList<mp.com.models.Movie>{
        val movieList: MutableList<mp.com.models.Movie> = mutableListOf()
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String): Boolean {
                ...
                mp.com.database.AppExecutors.getInstance().diskIO().execute(Runnable {
