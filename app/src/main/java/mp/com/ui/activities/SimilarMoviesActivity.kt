...
class SimilarMoviesActivity : AppCompatActivity(), mp.com.interfaces.OnMovieClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    lateinit var mSimilarAdapter: mp.com.adapters.MovieAdapter
    var similarData: MutableList<mp.com.models.Movie> = mutableListOf()
    ...
    private lateinit var movie: mp.com.models.Movie
    ...
    private fun initSimilarRecyclerView(){
        ...
        mSimilarAdapter = mp.com.adapters.MovieAdapter(similarData, this, mSharedPreferences)
        mSimilarRecyclerView.setAdapter(mSimilarAdapter)
    }

    private fun fetchSimilarMovie(){
        val call: Call<MovieRequest> = networkService.tmdbApi.getRecommendedMovies(movie.id.toString(),"17e4458dbfa36cf74f579fa0b3c596e4"
                ,"en-US",pageNumber)
            ...
            override fun onResponse(call: Call<MovieRequest>?, response: retrofit2.Response<MovieRequest>?) {
                ...
                if (movieRequest.results!!.isEmpty()){
                    ...
                    for (i in 0 until movieRequest.results!!.size){
                        val movie: mp.com.models.Movie = movieRequest.results!!.get(i)
    ...
    private fun addProgressBarInList() {
        val progressBarContent = mp.com.models.Movie()
