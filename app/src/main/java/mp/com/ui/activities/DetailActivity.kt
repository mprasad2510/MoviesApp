...
import mp.com.utils.Helpers.buildBackdropImageUrl
import mp.com.utils.Helpers.buildImageUrl
import mp.com.utils.Helpers.setUpTransparentStatusBar
...
import mp.com.utils.Helpers.buildImdbUrl
import mp.com.utils.Helpers.buildWikiUrl
import mp.com.viewmodels.MovieDetailsViewModel
import java.util.*


class DetailActivity : AppCompatActivity(), mp.com.interfaces.OnReviewReadMoreClickListener, mp.com.interfaces.OnVideoClickListener, SharedPreferences.OnSharedPreferenceChangeListener {

    private val TAG: String = DetailActivity::class.java.simpleName
    private var movie: mp.com.models.Movie = mp.com.models.Movie()
    ...
    private var movieDetail: mp.com.models.MovieDetail = mp.com.models.MovieDetail()
    ...
    //Reviews
    lateinit var mReviewReviewAdapter: mp.com.adapters.MovieReviewAdapter
    var data:MutableList<mp.com.models.MovieReview> = mutableListOf()
    ...
    //Cast
    lateinit var mCastAdapter: mp.com.adapters.CastAdapter
    private lateinit var mCastRecyclerView : RecyclerView
    private lateinit var mCastProgressBar : ProgressBar

    //Crew
    lateinit var mCrewAdapter: mp.com.adapters.CrewAdapter
    private lateinit var mCrewRecyclerView : RecyclerView
    private lateinit var mCrewProgressBar : ProgressBar

    //Trailer
    lateinit var mTrailerAdapter: mp.com.adapters.VideoAdapter
    var trailerData: MutableList<mp.com.models.MovieVideo> = mutableListOf()
    ...
    private fun isMovieFavourite(){
        ...
        val entry:LiveData<MutableList<mp.com.database.entities.FavouritesEntry>> = mDatabase.favouritesDao().checkIfFavourite(movie.id!!)
    ...
    private fun initViews(){
        ...
        detailsViewModel = ViewModelProviders.of(this, mp.com.Injection.provideMovieDetailsRepository())
    ...
    private fun initReviewRecyclerView(){
        ...
        mReviewReviewAdapter = mp.com.adapters.MovieReviewAdapter(this)
    ...
    private fun initCastRecyclerView(){
        ...
        mCastAdapter = mp.com.adapters.CastAdapter(mSharedPreferences)
    ...
    private fun initCrewRecyclerView(){
        ...
        mCrewAdapter = mp.com.adapters.CrewAdapter(mSharedPreferences)
    ...
    private fun initTrailerRecyclerView(){
        ...
        mTrailerAdapter = mp.com.adapters.VideoAdapter(trailerData, this, mSharedPreferences)
    ...
    private fun fetchMovieDetails(){
        detailsViewModel.getDetails(movieId = movie.id.toString()).observe(this , object: LiveData<mp.com.models.MovieDetail>(), Observer<mp.com.models.MovieDetail> {
            override fun onChanged(t: mp.com.models.MovieDetail?) {
                movieDetail = t!!
    ...
    private fun showReviewReadMoreBottomSheet(review: mp.com.models.MovieReview){
    ...
    private fun setFavouriteOnClickListener(){
        mAddToFavourite.setOnClickListener({
            val movieEntry = mp.com.database.entities.FavouritesEntry()
    ...
    override fun onReviewReadMoreClickListener(review: mp.com.models.MovieReview) {
        showReviewReadMoreBottomSheet(review)
    }
    override fun onVideoClickListener(movieVideo: mp.com.models.MovieVideo) {
