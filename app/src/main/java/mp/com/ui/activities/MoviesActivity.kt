...
class MoviesActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    internal lateinit var mMovieViewPagerAdapter    : mp.com.adapters.MovieViewPagerAdapter
    ...
    private fun setupViewPager() {
        mMovieViewPagerAdapter = mp.com.adapters.MovieViewPagerAdapter(getSupportFragmentManager())
