...
import mp.com.utils.Constants.Companion.NOWSHOWING
 ...
 */
class NowShowingMoviesFragment : Fragment(), mp.com.interfaces.OnMovieClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    lateinit var mMovieAdapter: mp.com.adapters.NowShowingAdapter
    ...
    private fun initRecyclerView() {
        ...
        viewModel = ViewModelProviders.of(this, mp.com.Injection.provideNowShowingViewModelFactory(context!!))
                .get(NowShowingViewModel::class.java)

        mMovieAdapter = mp.com.adapters.NowShowingAdapter(this, mSharedPreferences)
        mRecyclerView.adapter = mMovieAdapter


        viewModel.nowshowing.observe(this, Observer<PagedList<mp.com.database.entities.NowShowingEntry>> {
...
//            }
    ...
    private fun convertEntryToMovieList(list: List<mp.com.database.entities.NowShowingEntry>): MutableList<mp.com.models.Movie>{
