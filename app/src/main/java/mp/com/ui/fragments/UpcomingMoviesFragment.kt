...
class UpcomingMoviesFragment : Fragment(), mp.com.interfaces.OnMovieClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    lateinit var mMovieAdapter: mp.com.adapters.UpcomingAdapter
    ...
    private fun initRecyclerView() {
        ...
        viewModel = ViewModelProviders.of(this, mp.com.Injection.provideUpcomingViewModelFactory(context!!))
                .get(UpcomingViewModel::class.java)

        mMovieAdapter = mp.com.adapters.UpcomingAdapter(this, mSharedPreferences)
        mRecyclerView.adapter = mMovieAdapter

        viewModel.upcoming.observe(this, Observer<PagedList<mp.com.database.entities.UpcomingEntry>> {
    ...
    private fun convertEntryToMovieList(list: List<mp.com.database.entities.UpcomingEntry>): MutableList<mp.com.models.Movie>{
