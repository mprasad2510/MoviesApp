...
import mp.com.R
import mp.com.utils.Helpers.buildYouTubeThumbnailURL
import mp.com.viewholders.VideoViewHolder

/**
 * Created by Kashish on 04-08-2018.
 */
class VideoAdapter(private var movieVideoList: List<mp.com.models.MovieVideo>, listener: mp.com.interfaces.OnVideoClickListener, private val mSharedPreferences: SharedPreferences) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private lateinit var mContext: Context
    private var mListener: mp.com.interfaces.OnVideoClickListener
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        val movieVideo: mp.com.models.MovieVideo = movieVideoList.get(holder.adapterPosition)
