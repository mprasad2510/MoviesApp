...
class Movie() : Parcelable {
    ...
    companion object CREATOR : Creator<mp.com.models.Movie> {
        override fun createFromParcel(parcel: Parcel): mp.com.models.Movie {
            return mp.com.models.Movie(parcel)
        }

        override fun newArray(size: Int): Array<mp.com.models.Movie?> {
