package mp.com.utils

import android.graphics.Color
import android.os.Build
import android.view.View
import android.view.Window
import mp.com.utils.DateUtils.Companion.getDateFromEpoch
import mp.com.utils.Urls.Companion.MOVIE_DETAILS_BASE_URL
import android.view.WindowManager
import mp.com.utils.DateUtils.Companion.getYear
import java.util.*
...
object Helpers {
    ...
    fun buildSearchMovieUrl(query: String, pageNumber: Int, adult: String = "false"):String{
        return "https://api.themoviedb.org/3/search/movie?api_key=" + "17e4458dbfa36cf74f579fa0b3c596e4" +
    ...
    fun buildUpcomingMoviesUrl(pageNumber: Int, adult: String = "false"): String{
        return "https://api.themoviedb.org/3/movie/upcoming?api_key="+ "17e4458dbfa36cf74f579fa0b3c596e4"+
    ...
    fun buildTopRatedMoviesUrl(pageNumber: Int, adult: String = "false"): String{
        return Urls.BASE_URL +"movie/top_rated?api_key="+"17e4458dbfa36cf74f579fa0b3c596e4"+
                "&language=en-US&page="+pageNumber
    }

    fun buildNowShowingMoviesUrl(pageNumber: Int, adult: String = "false"): String{
        return Urls.BASE_URL +"movie/now_playing?api_key="+"17e4458dbfa36cf74f579fa0b3c596e4"+
    ...
    fun buildRecommendedMoviesUrl(pageNumber: Int, movieId: String): String{
        return Urls.BASE_URL + "movie/"+movieId+"/recommendations?" +
                "api_key="+ "17e4458dbfa36cf74f579fa0b3c596e4"+"&language=en-US&page="+pageNumber
    }

    fun buildPopularMoviesUrl(pageNumber: Int, adult: String = "false"): String{
        return Urls.BASE_URL +"movie/popular?api_key="+"17e4458dbfa36cf74f579fa0b3c596e4"+
                "&language=en-US&page="+pageNumber+"&region=US|IN|UK"
    }

    fun buildMovieCastUrl(movieId: String): String{
        return Urls.BASE_URL +"movie/"+movieId+"/credits?api_key="+ "17e4458dbfa36cf74f579fa0b3c596e4"
    }
    ...
    fun buildMovieDetailUrl(movieId: String): String {
        return MOVIE_DETAILS_BASE_URL + movieId + "?api_key=" + "17e4458dbfa36cf74f579fa0b3c596e4" + "&append_to_response=videos"
    }

    fun buildMovieReviewUrl(movieId: String, pageNumber: Int): String {
        return MOVIE_DETAILS_BASE_URL + movieId + "/reviews?api_key=" + "17e4458dbfa36cf74f579fa0b3c596e4" +
                "&language=en-US&page="+ pageNumber
    }
    ...
    fun buildDiscoverMovieUrl(pageNumber: Int,
        ...
        var url:String = "https://api.themoviedb.org/3/discover/movie?api_key=" + "17e4458dbfa36cf74f579fa0b3c596e4" +
                "&language=en-US&page=" + pageNumber+
